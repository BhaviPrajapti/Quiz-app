...
def submit():
    ...
    return render_template('result.html', user_answers=user_answers, score=score, total_questions=total_questions, percentage=formatted_percentage, feedback=feedback)
